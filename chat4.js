class ChatWidget extends HTMLElement {
  ...
  renderReactApp() {
    ...
    const reactCode = `
      ...
      function ChatApp() {
        ...
        useEffect(() => {
          ...
          if (clientContent && mainContent) {
            console.log('Found client content, integrating...');
            // Client content ko main content area mein move karo
            mainContent.appendChild(clientContent);
          } else {
            console.log('Client content not found, using fallback');
          }
        }, []);
        ...
        const styles = {
          ...
          sidebar: {
            ...
            pointerEvents: 'auto' // Only sidebar is interactive
          },
          resizer: {
            width: '1px',
          ...
          mainContent: {
            flex: 1,
            overflow: 'auto',
            pointerEvents: 'auto', // Main content interactive
        ...
        return React.createElement('div', { style: styles.container },
          ...
          // Toggle Button (Separate - always on top)
      ...
      console.log('✅ Chat widget React app rendered');
    `;
