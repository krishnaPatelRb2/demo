    ...
    const reactCode = `
      ...
      function ChatApp() {
        ...
        const handleMouseMove = (e) => {
          ...
          const newWidth = e.clientX; // Use clientX directly for left side
        ...
        const styles = {
          ...
          sidebar: {
            ...
            pointerEvents: 'auto',
            position: 'relative',
            order: -1 // Ensure sidebar comes first (left side)
          },
          chatContainer: {
            height: '100%',
            display: 'flex',
          ...
          resizer: {
            position: 'absolute',
            right: '-2px', // Changed from left to right for left-side sidebar
            top: 0,
            width: '4px',
            height: '100%',
            cursor: 'col-resize',
          ...
          toggleButton: {
            ...
            position: 'fixed',
            bottom: '20px',
            left: '20px', // Keep toggle button on left side
            display: 'flex',
            alignItems: 'center',
          ...
          React.createElement('div', { style: styles.mainLayout },
            ...
            React.createElement('div', { 
              ...
              showChatLayout && React.createElement('div', { style: styles.chatContainer },
                // Resizer Handle (on right side now)
                React.createElement('div', {
